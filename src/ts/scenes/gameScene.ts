...
class GameScene extends Scene {
  ...
  private noteInterval!: NodeJS.Timeout;
  ...
  private _gameOver(): void {
    ...
    // userRef.child("noteGenerateLag").set(this.noteGenerateLag);
  ...
  public start(): void {
    ...
    this.noteSpeed =
      this.GAME_DATA.TYPE === "AUTH" ? this.user.noteSpeed : this.noteSpeed;
    this.noteGenerateLag =
      this.GAME_DATA.TYPE === "AUTH"
